...
This is the authoritative contributor guide for the repository.
...
2. Make your changes.
3. Run the most relevant local checks before pushing.
4. Open a PR to `main`.
...
If your PR fails the gate, inspect the uploaded `ragas-ci-report` artifact to see which questions regressed.
